...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="<?php echo base_url()?>assets/assets/css/loginstyle.css" />
  </head>
<body>
	...
	<div class="row align-items-center g-0">
	  <div class="col-sm-6">
		<div id="carouselmundano" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
			...
			<div class="carousel-item">
			  <img src="<?php echo base_url()?>assets/Images/Amanda 2.jpg" class="d-block w-100" alt="<?php echo base_url()?>assets/Images SS3">
			  <div class="carousel-caption d-none d-md-block">
			  </div>
			</div>
			<div class="carousel-item">
			  <img src="<?php echo base_url()?>assets/Images/Artem 1.jpg" class="d-block w-100" alt="<?php echo base_url()?>assets/Images SS4">
			  <div class="carousel-caption d-none d-md-block">
			  </div>
			</div>
			<div class="carousel-item">
			  <img src="<?php echo base_url()?>assets/Images/Gill 1.jpg" class="d-block w-100" alt="<?php echo base_url()?>assets/Images SS5">
			  <div class="carousel-caption d-none d-md-block">
			  </div>
			</div>
		  </div>
	  ...
	  <div class="col-lg-6 px-5 pt-5">
		...
		<form>
		  <div class="form-row">
			<div class="col-lg-6">
			  <input type="Email" placeholder="name@domain.com" class="form-control my-2" />
			</div>
		  </div>
		  <div class="form-row">
			<div class="col-sm-6">
			  <input type="password" placeholder="minimun 8 characters" class="form-control my-2" />
			</div>
		  </div>
		  <div class="form">
			<div class="col-sm-6">
			  <a class="btn btn-dark mt-3 mb-5" href="index.html" role="button">Sign In</a>
			</div>
		  </div class>
